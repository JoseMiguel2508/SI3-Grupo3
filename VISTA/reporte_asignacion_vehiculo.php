...
<head>
    ...
    <title>Reporte de Asignación de Vehículos</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-4">
    <h2 class="text-center">📋 Reporte de Asignación de Vehículos</h2>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <?php if (!empty($reporte)): ?>
                <?php foreach ($reporte as $index => $fila): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($fila['conductor']) ?></td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6" class="text-center">No hay registros en el rango seleccionado.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
